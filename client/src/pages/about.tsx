                    ...
                    <div className="prose prose-slate max-w-none space-y-6">
                      ...
                      <section>
                        ...
                        <div className="bg-primary/5 p-4 rounded-lg mt-4 flex items-center gap-2">
                          ...
                          <span className="text-slate-700">Requests can be made at: <a href="mailto:support@artisanconnect.co.za" className="text-primary hover:underline" data-testid="link-privacy-email">support@artisanconnect.co.za</a></span>
                        </div>
                      </section>
                    ...
                    <div className="prose prose-slate max-w-none space-y-6">
                      ...
                      <section>
                        ...
                        <div className="bg-primary/5 p-4 rounded-lg mt-2 flex items-center gap-2">
                          <Mail className="h-5 w-5 text-primary flex-shrink-0" />
                          <span className="text-slate-700">For any queries, email: <a href="mailto:support@artisanconnect.co.za" className="text-primary hover:underline" data-testid="link-terms-email">support@artisanconnect.co.za</a></span>
                        </div>
                      </section>
                    </div>
                  </ScrollArea>
